...
class PongGame extends SurfaceView implements Runnable{
    ...
    public PongGame(Context context, int x, int y) {
        ...
        */
        ...
        initializeSoundPool(context);                       // Moved sound initialization to a separate method    
        startNewGame();
    }
    ...
    void draw() {
        if (mOurHolder.getSurface().isValid()) {
            ...
            mCanvas.drawText("Akashdeep Vasisht", 1200, 200, mPaint);     // Name Display
